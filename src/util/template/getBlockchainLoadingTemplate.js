const getBlockchainLoadingTemplate = ({ zoomLevel = 1, bg }) => {
    const html = `
  <!DOCTYPE html>
  <html>
    <head>
      ...
      <style>
        ...
        .loader {
            --duration: 3s;
            --primary: rgba(94, 196, 172, 1);
            --primary-light: rgba(94, 196, 172, 0.8);
...
export default getBlockchainLoadingTemplate;
