...
export class TransactionBuilder extends Ptr {
    ...
    async add_key_input(hash, input, amount) {
        ...
        const amountPtr = Ptr._assertClass(amount, Value);
        return HaskellShelley.transactionBuilderAddKeyInput(this.ptr, hashPtr, inputPtr, amountPtr);
    }
    ...
    async add_input(address, input, amount) {
        ...
        const inputPtr = Ptr._assertClass(input, TransactionInput);
        const amountPtr = Ptr._assertClass(amount, Value);
        return HaskellShelley.transactionBuilderAddInput(this.ptr, addressPtr, inputPtr, amountPtr);
    }
