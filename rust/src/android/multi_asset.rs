...
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_multiAssetNew(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_multiAssetLen(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_multiAssetInsert(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_multiAssetGet(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_multiAssetKeys(
  env: JNIEnv, _: JObject, multiAsset: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let multiAsset = multiAsset.rptr(&env)?;
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_multiAssetSub(
