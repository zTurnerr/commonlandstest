...
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_valueNew(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_valueCoin(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_valueSetCoin(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_valueMultiasset(
  env: JNIEnv, _: JObject, value: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let value = value.rptr(&env)?;
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_valueSetMultiasset(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_valueCheckedAdd(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_valueCheckedSub(
  env: JNIEnv, _: JObject, ptr: JRPtr, rhs: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let ptr = ptr.rptr(&env)?;
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_valueClampedSub(
  env: JNIEnv, _: JObject, ptr: JRPtr, rhs: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let ptr = ptr.rptr(&env)?;
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_valueCompare(
