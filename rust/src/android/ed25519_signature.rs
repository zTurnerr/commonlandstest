...
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_ed25519SignatureToBytes(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_ed25519SignatureFromBytes(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_ed25519SignatureToHex(
  env: JNIEnv, _: JObject, ptr: JRPtr,
) -> jobject {
  handle_exception_result(|| {
