...
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_assetsNew(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_assetsLen(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_assetsInsert(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_assetsGet(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_assetsKeys(
  env: JNIEnv, _: JObject, assets: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let assets = assets.rptr(&env)?;
