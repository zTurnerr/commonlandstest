...
#[no_mangle]
pub extern "C" fn Java_org_commonlands_mobile_Native_bigNumFromStr(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_bigNumToStr(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_bigNumCheckedAdd(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_bigNumCheckedSub(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_bigNumClampedSub(
  env: JNIEnv, _: JObject, ptr: JObject, other: JObject,
) -> jobject {
  handle_exception_result(|| {
    let rptr = ptr.rptr(&env)?;
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_bigNumCompare(
