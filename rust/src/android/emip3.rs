...
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_encryptWithPassword(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_org_commonlands_mobile_Native_decryptWithPassword(
